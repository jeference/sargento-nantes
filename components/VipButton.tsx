...
export function VipButton({ href }: { href: string }) {
  return (
    <a
      ...
      className="btn-gold group relative inline-flex w-full items-center justify-center gap-2.5 overflow-hidden rounded-xl px-6 py-4 text-xs sm:text-sm animate-pulse-gold"
    >
